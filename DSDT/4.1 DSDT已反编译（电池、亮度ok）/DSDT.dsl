 ...
 *
 * Disassembly of iASLvOGOsR.aml, Sat Feb 24 18:50:17 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000F2E9 (62185)
 ...
 */
DefinitionBlock ("", "DSDT", 1, "HASEE ", "PARADISE", 0x00000000)
{
    /*
    ...
    External (_SB_.PCI0.GFX0, UnknownObj)    // (from opcode)
    ...
    External (_SB_.PCI0.GFX0.DD1F.BRDX, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.GFX0.DD1F.BRUP, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.GFX0.DD1F.LGBR, MethodObj)    // 1 Arguments (from opcode)
    External (_SB_.PCI0.GFX0.DD1F.QBCM, MethodObj)    // 1 Arguments (from opcode)
    External (_SB_.PCI0.GFX0.DD1F.QBQC, MethodObj)    // 0 Arguments (from opcode)
    ...
    External (_SB_.PCI0.PEG0.PEGP.GCOF, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.PEG0.PEGP.MLTF, FieldUnitObj)    // (from opcode)
    ...
    External (_SB_.PCI0.SATA.P0P_, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.SATA.P1P_, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.SATA.P2P_, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.SATA.P3P_, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.XHC_.DUAM, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.XHC_.XWAK, MethodObj)    // Warning: Unknown method, guessing 0 arguments
    ...
    Name (DPPL, 0x8000)
    OperationRegion (GNVS, SystemMemory, 0x9CFACA98, 0x02F6)
    ...
    OperationRegion (OGNS, SystemMemory, 0x9CFADF18, 0x1E)
    ...
    Scope (_SB)
    {
        ...
        Device (BAT0)
        {
            ...
            {
                Store (B1B2 (^^PCI0.LPCB.EC0.DSC0, ^^PCI0.LPCB.EC0.DSC1), Index (PBIF, One))
                Store (B1B2 (^^PCI0.LPCB.EC0.LAC0, ^^PCI0.LPCB.EC0.LAC1), Index (PBIF, 0x02))
                Store (B1B2 (^^PCI0.LPCB.EC0.DSV0, ^^PCI0.LPCB.EC0.DSV1), Index (PBIF, 0x04))
                Store (Divide (B1B2 (^^PCI0.LPCB.EC0.DSC0, ^^PCI0.LPCB.EC0.DSC1), 0x0A, ), Index (PBIF, 0x05))
                Store (Divide (B1B2 (^^PCI0.LPCB.EC0.DSC0, ^^PCI0.LPCB.EC0.DSC1), 0x64, ), Index (PBIF, 0x06))
                Store ("MWL32b", Index (PBIF, 0x09))
                If (LLess (B1B2 (^^PCI0.LPCB.EC0.DSC0, ^^PCI0.LPCB.EC0.DSC1), 0x1770))
                {
                    Store ("MWL32b", Index (PBIF, 0x09))
                }

                If (LLess (B1B2 (^^PCI0.LPCB.EC0.DSC0, ^^PCI0.LPCB.EC0.DSC1), 0x0BB8))
                {
                    Store ("MWL31b", Index (PBIF, 0x09))
                }

                Store (^^PCI0.LPCB.EC0.RECB (0xD2, 0x40), Index (PBIF, 0x0C))
            }

            Method (UPBS, 0, NotSerialized)
            {
                If (LEqual (B1B2 (^^PCI0.LPCB.EC0.MBR0, ^^PCI0.LPCB.EC0.MBR1), Zero))
                {
                    Store (One, BTUR)
                }
                ...
                {
                    Add (Divide (B1B2 (^^PCI0.LPCB.EC0.DSC0, ^^PCI0.LPCB.EC0.DSC1), 0x32, ), B1B2 (^^PCI0.LPCB.EC0.MBR0, ^^PCI0.LPCB.EC0.MBR1), Local5)
                }
                ...
                Device (EC0)
                {
                    ...
                    Method (_REG, 2, NotSerialized)  // _REG: Region Availability
                    {
                        If (LAnd (LEqual (Arg0, 0x03), LEqual (Arg1, One)))
                        {
                            ...
                            CMSO (0x7E, 0xFF)
                            Store (0x08, BRST)
                            If (LOr (LEqual (BDID, 0x02), LEqual (BDID, 0x03)))
                            {
                                CKLS ()
                            }
                            ...
                            ElseIf (LOr (LEqual (BDID, 0x02), LEqual (BDID, 0x03)))
                            {
                                Store (Zero, FNON)
                                Store (Zero, SLMO)
                                CMSW (0x65, Zero)
...
\rmdt.p1("EC _QA0 exit")
                            ...
                            While (One)
                            {
                                ...
                                If (LEqual (_T_0, 0x0109))
                                {
                                    If (LEqual (GETW (Local0, 0x04), One))
                                    {
                                        ...
                                        Store (B1B4 (^^EC0.VER0, ^^EC0.VER1, ^^EC0.VER2, ^^EC0.VER3), Local1)
                                        Store (Local1, Local2)
                                        Store (Local1, Local3)
                                        Store (Local1, Local4)
                ...
                If (LEqual (Arg0, ToUUID ("c4eb40a0-6cd2-11e2-bcfd-0800200c9a66")))
                {
                    ...
                    If (LEqual (Arg2, One))
                    {
                        ...
                        If (LNotEqual (And (PEPC, 0x03), 0x02))
                        {
                            ...
                            If (LEqual (^^PCI0.SATA.P0P, Zero))
                            {
                                Store (Zero, Index (DerefOf (Index (DEVY, 0x06)), One))
                            }

                            If (LEqual (^^PCI0.SATA.P1P, Zero))
                            {
                                Store (Zero, Index (DerefOf (Index (DEVY, 0x07)), One))
                            }

                            If (LEqual (^^PCI0.SATA.P2P, Zero))
                            {
                                Store (Zero, Index (DerefOf (Index (DEVY, 0x08)), One))
                            }

                            If (LEqual (^^PCI0.SATA.P3P, Zero))
                            {
                                Store (Zero, Index (DerefOf (Index (DEVY, 0x09)), One))
                            }
                        }
    ...
    OperationRegion (MDBG, SystemMemory, 0x9CFA9018, 0x1004)
